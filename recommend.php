...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p align="center"><font size = "36" color = 'white'>Recommend Concerts to Your Friends</font> </p>
  <div align="center">
        ...
        <form action ="" method = 'POST'>
          <td><label for="search">
            ...
            <div align="center">
              ...
              <p><a href="list.php">See Your List of Recommendations</a></p>
          </div></td>
        </tr>
      </tbody>
      </table>
...
echo"<td><div id='ck-button'><label><input type='checkbox' name='cid[]' value=".$cid."><span>RECOMMEND</span></label></div>
   </td>";
                     echo "</tr>\n";
		echo "</center>";
        }
    ...
    echo "Error: " . $stmt . "<br>" . $mysqli->error;
              ...
              {
                $query = $mysqli->prepare("Insert into r_concert values('$userid','$int[$i]',now())");
                $query->execute();
                $query->store_result();
              }
