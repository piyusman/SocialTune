...
<div align="center">
  ...
  <p>&nbsp;</p>
  <p align="center"><font size = "36" color = 'white'>Here is your List</font> </p>
  <div align="center">
  ...
  <p>&nbsp;</p>
       ...
       if ($stmt =$mysqli->prepare("Select distinct concert.cid,cname,vname,start_time,concert_date,bname,tickets_sold,price from test.concert,test.r_concert
where r_concert.cid = concert.cid AND r_concert.userid ='$userid'"));
...
echo"<td><div id='ck-button'><label><input type='checkbox' name='cid[]' value=".$cid."><span>CANCEL</span></label></div>
   </td>";
                     echo "</tr>\n";
		echo "</center>";
        }
    ...
    if(isset($_POST['submit2']))
            {
              ...
              {
                $query = $mysqli->prepare("DELETE from  r_concert where userid = '$userid' AND cid = '$int[$i]' ");
                $query->execute();
                $query->store_result();
              }
